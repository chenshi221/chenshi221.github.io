...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x1.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x2.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x3.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x4.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x5.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x7.png)

Figure 6: Mask sampling strategies determine the pretext task difficulty, influencing reconstruction quality and representations (Table LABEL:tab:mask\_types ). Here each output is from an MAE trained with the specified masking strategy. Left: random sampling (our default). Middle: block-wise sampling 2 that removes large random blocks. Right: grid-wise sampling that keeps one of every four patches. Images are from the validation set.
...
In Table LABEL:tab:mask\_types we compare different mask sampling strategies, illustrated in Figure 6.
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x8.png)
...
\\begin{overpic}\[percent,width=424.94574pt\]{fig/model\_size} \\put(86.8,9.8){\\tiny\\cite\[cite\]{\[\\@@bibref{}{Dosovitskiy2021}{}{}\]}} \\put(90.8,6.8){\\tiny\\cite\[cite\]{\[\\@@bibref{}{Dosovitskiy2021}{}{}\]}} \\end{overpic}
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x10.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x11.png)
...
![Refer to caption](https://ar5iv.labs.arxiv.org/html/2111.06377/assets/x12.png)
